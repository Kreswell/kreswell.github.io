...
However, if we look closely, we notice a serious problem. We can't just pick two points in empty space. How would we clearly specify them?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjkyMDUwMTc5LDE3NDYzNDY0NTIsLTMxNj

...
In more familiar terms, if I want to write down an arbitrary real number in decimal notation *exactly*, I have to write down *all* of its digits. This, of course, cannot be done in finite time. Thus, if I want to measure some real-world quantity, such as the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjQyMTg4OTgsLTYzMzkwNDk0Niw5OD

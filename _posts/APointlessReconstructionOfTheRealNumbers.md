...
The best we can do when making a measurement -- indeed, what we actually do whenever we make a measurement -- is to specify a range
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjY1MjI1NDAsLTExNTE5ODUzMzIsLT

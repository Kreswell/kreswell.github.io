...
In more familiar terms, if I want to write down an arbitrary real number in decimal notation *exactly*, I have to write down *all* of its digits. This, of course, cannot be done in finite time. Thus, if I want to measure some real-world quantity *exactly*, such as the distance between to points, I have to determine *all* of the significant digits of the measurement. Even if the quantity has some "nice" value -- $2$ cm, for example -- to unambiguously determine this, we still have to determine all of it's significant digits. Otherwise, how do we know that the true value isn't, say, $2.0000000000000000143052\dots$ cm or $1.999999999999999$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzNTk3NzE5MCwtNjMzOTA0OTQ2LDk4Mz

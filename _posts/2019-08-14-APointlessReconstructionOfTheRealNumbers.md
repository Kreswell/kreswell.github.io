...
Let's take $$\mathbb{R}$$, as usual, to be the set of limits of sequences of rational numbers. We can think of it as the set of all decimal expressions with finite integer part.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwNDc0Nzg5OCwtNTQ0OTE1Njg0LC0xNj

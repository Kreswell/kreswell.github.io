...
such that $$(\mathcal{T},\subseteq)$$ is a (generalized) topology.  Let $$\mathcal{B}$$ be a countable (topological) base for $$(\mathcal{T},\subseteq)$$ such that each $$B \in \mathcal{B}$$ is the (setwise) principal for an ultrafilter.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxNzUzNzgxNCw1ODk2NzczNDIsMTQ1OT

...
2. The lattice induced by $$\subseteq$$ is complete in the sense that $$A$$ is a proper subset of $$C$$ if and only if there is a $$B
...
Since the sets $$\mathcal{B}$$ are *open* sets
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1NDI5MjI0NCwtNDM3MTE0NDQwLC0zND

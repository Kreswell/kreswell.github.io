...
The key idea is that, while this bin structure can always be refined, this is the best we can do in finite steps. We cannot take the limit of infinitesimal refinement in finite time.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mjc2MzQxMDksLTQzNzExNDQ0MCwtMz

...
I think that thiI got hung up on trying to find the "right" topic for my next post. Since I want to write (semi-)professionally about physics and math, I've been trying to keep the focus of my current posts on those topics. But I think that, instead, I need to give myself permission to write about *whatever*. I have a lot I want to say about physics and math, but that can wait. For now, I just need to write about anything and everything that comes out, until it becomes such a habit that it feels weird to have a day when I don't do any writing.



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxNjAwOTA1NCwtMTA4NTAxNDExNywyMT
